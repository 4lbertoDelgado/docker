...
*Ejemplo*
```
//Muestra todos los contenedores que su estatus sea Exited 0 = Comando se ejecuto correctamente. Exited 1 = Comando se ejecuto con error 
...
*Ejemplo*
```
//Esto permitira ingresar a un contenedor por la puerta trasera y lanzarle las banderas -it para volverlo interactivo y ejecutar un bash
